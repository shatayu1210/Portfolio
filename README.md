...
## 🚀 Featured: AgenticAI AutoBot
**Autonomous GitHub Issue Resolution & Proactive Monitoring**

A multi-agent system designed to handle the entire lifecycle of software maintenance—from detecting high-risk issues in real-time to generating and validating code patches autonomously.

- **Smart Monitoring**: Uses a custom reasoning engine to scan GitHub issues, triage risks, and alert teams via Slack with cited evidence.
- **Autonomous Patching**: A collaborative agent workflow that plans, writes, and tests code fixes without human intervention.
- **Key Tech**: LangGraph, GraphRAG (Neo4j), Fine-tuned Qwen2.5, Go, Prometheus.
- [**Explore Project**](./AgenticAI_AutoBot)
