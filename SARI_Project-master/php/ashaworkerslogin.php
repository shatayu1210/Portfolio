...
if (isset($_POST['ashasigin'])) {
  if (isset($_POST['username']) && !empty($_POST['username'])) {
      $mail = mysqli_real_escape_string($con,trim($_POST['username']));
      $query = "SELECT * FROM ashaworkers WHERE ashamail='$mail'";
...
<body>
  ...
  <!--Content-->
    ...
    <div class="card logincard animated jackInTheBox">
        ...
        <h3 style="text-align: center; font-weight: 800">Form Login</h3><br>
                ...
                <input type="submit" style="width: 120px;height: 40px;" name="ashasigin" value="Login"class="btn btn2"/>
                <br><br>
              </div><br>
                </form>
