...
if (isset($_POST['totalgraph'])) {
  ...
  $date1 = explode('-', mysqli_real_escape_string($con,$_POST['date1']));
               ...
               $query4="SELECT travelhis,travelper,housenearby,sym_other,comorbid_other,pat_gender,fever,cough,breath,hypertension,diabetes,cardiac,respiratory,cancer,pregnant,immuno FROM patient WHERE district_id=$distid  &&  timestamp BETWEEN $timeStamp AND $timeStamp2;";
               //echo $query4;
