...
if (isset($_POST['excelurban'])) {
  ...
  $date1 = explode('-', mysqli_real_escape_string($con,$_POST['date1']));
               ...
               $query4="SELECT * FROM patient WHERE district_id=$distid  && area_id=1 && timestamp BETWEEN $timeStamp AND $timeStamp2 ORDER BY timestamp DESC;";
               // echo $query4;
      ...
      <table id="example" class="display" style="width:90%;margin:auto;">
          ...
          <tbody>
            ...
            while ($row4 = mysqli_fetch_assoc($result4)) {
              ...
              $query9="SELECT * FROM blockurban WHERE bu_id=$blockid;";
