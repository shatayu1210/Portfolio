...
if (isset($_POST['extractruralpdf'])) {
  ...
  $date1 = explode('-', mysqli_real_escape_string($con,$_POST['date1']));
               ...
               $query4="SELECT * FROM patient WHERE district_id=$distid && area_id=0 && timestamp BETWEEN $timeStamp AND $timeStamp2 ORDER BY timestamp DESC;";
               // echo $query4;
    ...
    <table id="example" class="display" style="width:90%;margin:auto;">
        ...
        <tbody>
          ...
          while ($row4 = mysqli_fetch_assoc($result4)) {
            ...
            $query8="SELECT * FROM district WHERE district_id=$distid;";
            $result8 = mysqli_query($con, $query8);
            $row8 = mysqli_fetch_assoc($result8);
            $query9="SELECT * FROM block WHERE b_id=$blockid;";
            $result9 = mysqli_query($con, $query9);
            $row9 = mysqli_fetch_assoc($result9);
            $query10="SELECT * FROM phc WHERE phc_id=$phcid;";
            ...
            echo "<tr>
            <td>".$row8['district_name']."</td>
            <td>".$row9['b_name']."</td>
            <td>".$row10['phc_name']."</td>
            <td>".$row11['sub_name']."</td>
            <td>".$row12['v_name']."</td>
            <td>".$row4['pat_name']."</td>
            <td>".$gender."</td>
