      ...
      <form class=""  id="add_name" method="post" >
         <div class="row">
            <div class="col">
               ...
               <span id="dist1" class="text-info" style="font-weight: 300"></span><br>
            </div>
            <div class="col">
               <div id="rates">
               ...
               <span id="rates1" class="text-info" style="font-weight: 300"></span>
            </div>
         </div>
         <div class="row">
            <div class="col">
               <div id='rural_urban_layer' ></div>
               <span id="rural_urban_layer1" class="text-info" style="font-weight: 300"></span>
            </div>
            <div class="col">
               <div id='mnpa'></div>
               <span id="mnpa1" class="text-info" style="font-weight: 300"></span>
            </div>
         </div>
         <div class="row">
            <div class="col">
         ...
         <div class="row">
         <span id="urbanrural1" class="text-info" style="font-weight: 300"></span>
         </div>
         <div class="row">
            <div class="col">
               <div class="form-group">
                  ...
                  <span id="pname1" class="text-info" style="font-weight: 300"></span>
               </div>
            </div>
         </div>
         <div class="row">
         ...
         <span id="pgender3" class="text-info" style="font-weight: 300"></span>
         <div class="row">
            <div class="col">
               <div class="form-group">
                  ...
                  <small>Years</small>
                  <span id="age1" class="text-info" style="font-weight: 300"></span>
               </div>
            </div>
            <div class="col">
               <div class="form-group">
                  ...
                  <select id="month" name='pagemonths' class="form-control">
                     <option disabled selected value="0">Select Months</option>
                  ...
                  <small>Month</small>
                  <span id="month1" value='1' class="text-info" style="font-weight: 300"></span>
               </div>
            </div>
         </div>
         <div class="row">
         ...
         <span id="pnumber1" class="text-info" style="font-weight: 300"></span>
         <div class="col">
            <div class="form-group">
         ...
         <div class="row">
            <div class="col">
               <div class="form-group">
                  ...
                  <span id="sympdays1" class="text-info" style="font-weight: 300"></span>
               </div>
            </div>
            <div class="col">
               <div class="form-group">
                  ...
                  <span id="hpdate1" class="text-info" style="font-weight: 300"></span>
               </div>
            </div>
         </div>
         <div class="col">
         ...
         <div class="row">
            <div class="col">
               <div class="form-group">
                  ...
                  <span id="travelhis1" class="text-info" style="font-weight: 300"></span>
               </div>
            </div>
         </div>
         <div class="row">
         ...
         <div class="row">
            <div class="col">
               <div class="form-group">
                  ...
                  <span id="travelper1" class="text-info" style="font-weight: 300"></span>
               </div>
            </div>
         </div>
         <div class="row">
         ...
         <div class="row">
            <div class="col">
               <div class="form-group">
                  ...
                  <span id="near1" class="text-info" style="font-weight: 300"></span>
               </div>
            </div>
         </div>
         <div class="row">
         ...
         <div class="row">
            <div class="col">
               <div class="form-group">
                  ...
                  <span id="pnumber121" class="text-info" style="font-weight: 300"></span>
               </div>
            </div>
            <div class="col">
               <div class="form-group">
                  ...
                  <span id="pnumber122" class="text-info" style="font-weight: 300"></span>
               </div>
            </div>
         </div>
         ...
         <span id="getloc" class="text-info" style="font-weight: 300"></span>
         <br><br>
         ...
         $(document).ready(function(){
           ...
           $('#submit').click(function(){
                 ...
                 if(district==0){
                  ...
                  else if(urbanruralcheck==0){
console.log('uyrban');
                     if(block==0){

                   document.getElementById('urbanrural1').innerHTML ="Select a Block and Municipal Corporation.";
                  ...
                  else if(urbanruralcheck==1){
                     console.log('rural');

                     if(block==0){

document.getElementById('urbanrural1').innerHTML ="Select a Block, PHC, Subcenter and Village.";
...
function breakme(){
    if(n.trim()==""){
                   document.getElementById('rates1').innerHTML ="";
                    document.getElementById('dist1').innerHTML ="";
                  //   document.getElementById('urbanrural1').innerHTML ="";
