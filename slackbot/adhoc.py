...
def handle_adhoc_query(query: str, issue_number: int = None) -> str:
    ...
    summary_system = (
        ...
        "  * Format the assignee or author name in bold italics (e.g., _*username*_).\n"
        "  * Format the status (open, closed, merged) in bold caps inside brackets (e.g., *[OPEN]* or *[MERGED]*).\n"
