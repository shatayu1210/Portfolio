"""Minimal REST client for vLLM server (chat-completions)."""
...
class VLLMClient:
    ...
    def generate(
        ...
        *,
        ...
        We send a system message (if provided) plus a single user message that
        contains the formatted schema/RAG/question prompt.
        """
